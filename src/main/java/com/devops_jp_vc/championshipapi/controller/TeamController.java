...
import com.devops_jp_vc.championshipapi.dto.TeamDTO;
...
public class TeamController {
    ...
    public ResponseEntity<TeamDTO> addPlayer(@RequestParam UUID playerId, @RequestParam UUID teamId) {
        ...
        TeamDTO teamDTO = new TeamDTO(updatedTeam.getName(), updatedTeam.getPlayerList(),
                updatedTeam.getRankingPoints());
