...
public class PlayerController {
    ...
    public ResponseEntity<PlayerDTO> create(@RequestBody Player player) {
        ...
        URI location = ServletUriComponentsBuilder.fromCurrentRequest()
                ...
                .toUri();
        PlayerDTO playerDTO = new PlayerDTO(newPlayer.getName(), newPlayer.getAge(), newPlayer.getHabilityPoints(), newPlayer.getPosition());
    ...
    public ResponseEntity<PlayerDTO> findOne(@PathVariable UUID id) {
        ...
        PlayerDTO playerDTO = new PlayerDTO(player.getName(), player.getAge(), player.getHabilityPoints(), player.getPosition());
